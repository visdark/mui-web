            ...
            if (fotorama !== undefined) {
                ...
                $showIcons.off().on(
                    'click', function (e) {
                        ...
                        $(this).addClass('open');
                        $(this).parent().find('ul').addClass('open');
                        $(this).parent().find('ul').find('a').on('click', function (event) {
...
function initCarousel(owl) {
    ...
    $(owl).each(
        function (index, carousel) {
            ...
            if ($('body' ).hasClass('inverse') || $('body' ).hasClass('color_bg')) {
...
function DaysLeft() {
    ...
    this.data = "";
    this.path = 1;
    this.lineColor = 'rgba(255,255,255,0)';
    //*****************************/
    this.x1Rand;
    this.x1Width;
    this.y1Rand;
...
(function () {
    ...
    if (dayBlocks) {
        ...
        if ($('body' ).hasClass('inverse') || $('body' ).hasClass('color_bg')) {
            initDaysLeft(
                dayBlocks, {
                    width: 0, // width element
                    height: 0, // height element
                    duration: 2000, // duration animation
                    time: 500, // duration delay
                    numberColor: 'rgba(0,0,0,0)', // color of Number
            ...
            initDaysLeft(
                dayBlocks, {
                    ...
                    duration: 2000, // duration animation
                    time: 500, // duration delay
                    numberColor: 'rgba(255,255,255,0)', // color of Number
                    numberFont: '30px Abel', // font
...
$(window).load(
    function () {
        ...
        try {
             ...
             */
            // var pre       = document.querySelector( '.mondePreloader' );
            // if( pre ) {
